...
require (
	...
	github.com/go-kratos/kratos/contrib/registry/etcd/v2 v2.0.0-20241218102003-f75bdc15ed72
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.1012
