...
//
//	mockgen -source=./user.go -package=svcmocks -destination=./mocks/user.mock.go
//
...
import (
	context "context"
	domain "goworkwebook/webook003/internal/domain"
	reflect "reflect"
...
func (m *MockUserService) FindById(ctx context.Context, uid int64) (domain.DMUser, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindById", ctx, uid)
	ret0, _ := ret[0].(domain.DMUser)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserService) FindOrCreate(ctx context.Context, phone string) (domain.DMUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserService) FindOrCreateByWechat(ctx context.Context, info domain.WechatInfo) (domain.DMUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserService) Login(ctx context.Context, email, password string) (domain.DMUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserService) Signup(ctx context.Context, u domain.DMUser) error {
	m.ctrl.T.Helper()
...
func (m *MockUserService) UpdateNonSensitiveInfo(ctx context.Context, user domain.DMUser) error {
	m.ctrl.T.Helper()
