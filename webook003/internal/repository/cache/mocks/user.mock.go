...
//
//	mockgen -source user.go -destination mocks/user.mock.go -package cachemocks
//
...
func (m *MockUserCache) Get(ctx context.Context, uid int64) (domain.DMUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserCache) Set(ctx context.Context, du domain.DMUser) error {
	m.ctrl.T.Helper()
