...
//
//	mockgen -source user.go -destination mocks/user.mock.go -package repomocks
//
...
func (m *MockUserRepository) Create(ctx context.Context, u domain.DMUser) error {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindByEmail(ctx context.Context, email string) (domain.DMUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindById(ctx context.Context, uid int64) (domain.DMUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindByPhone(ctx context.Context, phone string) (domain.DMUser, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) UpdateNonZeroFields(ctx context.Context, user domain.DMUser) error {
	m.ctrl.T.Helper()
